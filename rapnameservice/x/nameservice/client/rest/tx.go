...
func buyRapNameHandler(cliCtx context.CLIContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req buyRapNameReq
		...
		// create the message
		msg := types.NewMsgBuyRapName(req.Name, coins, addr)
...
func deleteNameHandler(cliCtx context.CLIContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		// create the message
		msg := types.NewMsgDeleteRapName(req.RapName, addr)
		err = msg.ValidateBasic()
